...
#
# Usage (from Kaliyai repo, or with GH_REPO=owner/name):
#   export GH_REPO=CastaliaInstitute/Kaliyai   # optional; defaults from git remote
...
#   { "cname": "kaliyai.castalia.institute", "https_enforced": true, "build_type": "workflow" }
#   JSON

set -euo pipefail

CNAME="kaliyai.castalia.institute"
REPO="${GH_REPO:-CastaliaInstitute/Kaliyai}"
...
echo ""
echo "Next: (1) CNAME in Cloudflare: kaliyai -> castaliainstitute.github.io (proxied)."
