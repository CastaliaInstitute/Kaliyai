...
<section class="kali-pillars" id="three-pillars" aria-label="What makes up Kali AI">
  ...
  <div class="kali-pillar-grid">
    <article class="kali-card">
      ...
      <h3>Anubis</h3>
      <p>Kotlin, Jetpack Compose, and a built-in <strong>MCP</strong> engine. Gemini function-calls become shell intent and tool use — not a web wrapper, a <strong>device-native</strong> control plane.</p>
    </article>
    <article class="kali-card">
      <span class="kali-card-icon" aria-hidden="true">
      ...
      <p>Host scripts to bring up a <strong>OnePlus One (bacon)</strong> on LineageOS, Magisk, and a full <strong>Kali 2026.1</strong> chroot — the hardware lab this stack was built against.</p>
    </article>
    <article class="kali-card">
      <span class="kali-card-icon" aria-hidden="true">
      ...
      <h3>OpenVAS / GVM</h3>
      <p>Full <strong>Greenbone</strong> story: <code>deploy.sh</code> from your Mac, chroot services, and a <strong>Docker + gvm-cli</strong> path when the stock kernel can’t run PostgreSQL on-device.</p>
    </article>
  </div>
</section>
...
<section class="kali-arch" id="flow" aria-label="Architecture diagram">
  ...
  <svg class="kali-flow-svg" viewBox="0 0 800 200" width="100%" style="max-height: 220px;" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Data flow: Anubis to Gemini, MCP, then Kali chroot">
    ...
    <text x="8" y="16" fill="#3d5a48" font-size="9" font-family="JetBrains Mono, monospace">* GVM: full stack or Docker+phone; see openvas</text>
  </svg>
</section>
...
<div class="kali-components">
  ...
  <table>
    ...
    <tbody>
      <tr><td><code>install-magisk-bacon.sh</code></td><td>Magisk-patched <code>boot</code> + fastboot.</td></tr>
      <tr><td><code>install-kali-linux-large.sh</code></td><td>Full Kali rootfs in the chroot.</td></tr>
